...
struct table ve_vs_rpm_and_map __attribute__((section(".configdata"))) = {
  ...
  .data = {
   ...
   /*  250,   500,   900,  1200,  1600,   2000,  2400,  3000, 3600,  4000,   4400,  5200,  5800,  6400,  6800,  7200}, */
      ...
      {65.0,  45.0,  72.0,  72.0,  83.0,  83.0,  88.0,  88.0,  88.0,  91.0,  90.0,  88.0,  88.0,  86.0,  86.0,  88.0}, /* 160 */
      {65.0,  45.0,  72.0,  72.0,  83.0,  83.0,  88.0,  88.0,  88.0,  92.0,  90.0,  88.0,  88.0,  86.0,  86.0,  88.0}, /* 180 */
      {65.0,  45.0,  72.0,  72.0,  83.0,  83.0,  88.0,  88.0,  88.0,  90.0,  88.0,  88.0,  88.0,  86.0,  86.0,  88.0}, /* 200 */
      {65.0,  45.0,  72.0,  72.0,  83.0,  83.0,  88.0,  88.0,  88.0,  88.0,  88.0,  88.0,  88.0,  86.0,  86.0,  88.0}, /* 220 */
      {65.0,  45.0,  72.0,  72.0,  83.0,  83.0,  88.0,  88.0,  88.0,  88.0,  88.0,  88.0,  88.0,  86.0,  86.0,  88.0}, /* 240 */
    },
  },
};

...
struct table ve_vs_rpm_and_map __attribute__((section(".configdata"))) = {
  ...
  .data = {
    .two = {
   /*  250,   500,   900,  1200,  1600,   2000,  2400,  2800, 3200,  3600,  4000,   4400,  5200,  5800,  6400,  6800,  7200}, */
      {75.0,  50.0,  50.0,  50.0,  60.0,  65.0,  65.0,  65.0,  65.0,  65.0,  65.0,  65.0,  65.0,  65.0,  65.0,  65.0,  65.0}, /* 23 */
      {75.0,  55.0,  52.0,  55.0,  58.0,  58.0,  61.0,  60.0,  60.0,  75.0,  70.0,  70.0,  70.0,  70.0,  70.0,  70.0,  70.0}, /* 30 */
      {75.0,  60.0,  60.0,  65.0,  67.0,  62.0,  67.0,  70.0,  68.0,  68.0,  70.0,  70.0,  70.0,  70.0,  70.0,  70.0,  70.0}, /* 40 */
      {75.0,  55.0,  66.0,  68.0,  69.0,  68.0,  75.0,  70.0,  75.0,  70.0,  70.0,  70.0,  70.0,  70.0,  70.0,  70.0,  70.0}, /* 50 */
      {75.0,  55.0,  68.0,  68.0,  70.0,  72.0,  80.0,  76.0,  85.0,  75.0,  71.0,  71.0,  70.0,  70.0,  70.0,  70.0,  70.0}, /* 60 */
      {75.0,  55.0,  75.0,  75.0,  78.0,  77.0,  83.0,  80.0,  78.0,  85.0,  77.0,  77.0,  76.0,  77.0,  77.0,  77.0,  77.0}, /* 70 */
      {75.0,  55.0,  82.0,  82.0,  84.0,  79.0,  83.0,  80.0,  84.0,  84.0,  80.0,  80.0,  84.0,  80.0,  78.0,  78.0,  78.0}, /* 80 */
      {75.0,  55.0,  82.0,  88.0,  89.0,  89.0,  90.0,  88.0,  96.0,  96.0,  93.0,  90.0,  90.0,  80.0,  80.0,  80.0,  82.0}, /* 90 */
      {75.0,  55.0,  82.0,  88.0,  92.0,  90.0,  91.0,  90.0,  91.0,  91.0,  90.0,  90.0,  90.0,  87.0,  87.0,  88.0,  88.0}, /* 100 */
      {75.0,  55.0,  82.0,  88.0,  93.0,  93.0,  96.0,  96.0,  91.0,  91.0,  92.0,  92.0,  92.0,  90.0,  90.0,  90.0,  90.0}, /* 120 */
      {75.0,  55.0,  82.0,  88.0,  93.0,  93.0,  95.0,  98.0, 100.0, 100.0,  99.0, 100.0, 100.0, 100.0, 100.0, 100.0, 100.0}, /* 140 */
      {75.0,  55.0,  82.0,  88.0,  93.0,  93.0,  98.0,  99.0,  98.0,  98.0, 101.0, 100.0,  98.0,  98.0,  96.0,  96.0,  98.0}, /* 160 */
      {75.0,  55.0,  82.0,  88.0,  93.0,  93.0,  98.0,  99.0,  98.0,  98.0, 102.0, 100.0,  98.0,  98.0,  96.0,  96.0,  98.0}, /* 180 */
      {75.0,  55.0,  82.0,  88.0,  93.0,  93.0,  98.0,  99.0,  98.0,  98.0, 100.0,  98.0,  98.0,  98.0,  96.0,  96.0,  98.0}, /* 200 */
      {75.0,  55.0,  82.0,  88.0,  93.0,  93.0,  98.0,  99.0,  98.0,  98.0,  98.0,  98.0,  98.0,  98.0,  96.0,  96.0,  98.0}, /* 220 */
      {75.0,  55.0,  82.0,  88.0,  93.0,  93.0,  98.0,  99.0,  98.0,  98.0,  98.0,  98.0,  98.0,  98.0,  96.0,  96.0,  98.0}, /* 240 */
    },
  },
};
